...
MBP_VERSION=mbp
FEDORA_KERNEL_VERSION=5.18.5-200.fc36      # https://bodhi.fedoraproject.org/updates/?search=&packages=kernel&releases=F36
REPO_PWD=$(pwd)
...
cp -rfv patches.zip ./output_zip/patches.zip
du -h ./output_zip/
