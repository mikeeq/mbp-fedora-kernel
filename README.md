...
sudo -i
curl -L https://raw.githubusercontent.com/mikeeq/mbp-fedora-kernel/v6.6-f38/update_kernel_mbp.sh -o /usr/bin/update_kernel_mbp
...
sudo -i
KERNEL_VERSION="6.6.0-f38" update_kernel_mbp
...
sudo -i
KERNEL_VERSION="6.6.0-f38" UPDATE_SCRIPT_BRANCH="v6.6-f38" update_kernel_mbp
