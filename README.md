...
sudo -i
curl -L https://raw.githubusercontent.com/mikeeq/mbp-fedora-kernel/v6.11-f40/update_kernel_mbp.sh -o /usr/bin/update_kernel_mbp
...
sudo -i
KERNEL_VERSION="6.11.3-f40" update_kernel_mbp
...
sudo -i
KERNEL_VERSION="6.11.3-f40" UPDATE_SCRIPT_BRANCH="v6.11-f40" update_kernel_mbp
