...
echo "CONFIG_APPLE_BCE=m" >> "${SPECS_PATH}/kernel-x86_64-fedora.config"
echo "CONFIG_APPLE_BCE=m" >> "${SPECS_PATH}/kernel-x86_64-debug-fedora.config"
echo "CONFIG_APPLE_IBRIDGE=m" >> "${SPECS_PATH}/kernel-local"
echo "CONFIG_APPLE_IBRIDGE=m" >> "${SPECS_PATH}/kernel-x86_64-fedora.config"
echo "CONFIG_APPLE_IBRIDGE=m" >> "${SPECS_PATH}/kernel-x86_64-debug-fedora.config"
